...
/**
 * This class introduces the button which will be used to execute OFF typed requests
 */
class OFFButton implements ActionListener {
    ...
    /**
     * Constructor for a OFFButton object
     ...
     */
    public OFFButton(View view,String equipement, JLabel label){
        this.view = view;
    ...
    public void actionPerformed(ActionEvent e) {
        String request = view.getSat().getName()+":"+equipement+":OFF";
